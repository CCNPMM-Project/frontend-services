...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setAlert({
                show: true,
                type: "success",
                message: response.data.message || "Đăng ký thành công! Vui lòng kiểm tra email để lấy OTP."
            });
    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            ...
            setAlert({ show: true, type: "success", message: response.data.message || "Xác thực OTP thành công!" });
            setIsOtpModalOpen(false);
            navigate("/login");
        } catch (error) {
            console.error("Error:", error);
            setAlert({ show: true, type: "error", message: error.response?.data?.message || "OTP không hợp lệ." });
        } finally {
            setIsLoading(false);
        }
    };
